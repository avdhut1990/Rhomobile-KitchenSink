...
-(void) init:(NSString*)google_api_key google_app_id:(NSString*)google_app_id gcm_sender_id:(NSString*)gcm_sender_id google_project_id:(NSString*)google_project_id google_storage_bucket:(NSString*)google_storage_bucket methodResult:(id<IMethodResult>)methodResult;
