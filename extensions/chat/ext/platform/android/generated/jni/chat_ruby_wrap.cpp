...
#define DEFAULT_LOGCATEGORY "ChatRUBY"


typedef rho::CChatProxy<ArgumentsAdapter<std::vector<VALUE> > > ObjectProxy;
...
{
    RAWTRACE("rb_Chat_s_default");
    return rho_ruby_create_object_with_id(klass, rho::CChatBase::getDefaultID().c_str());
}

VALUE rb_Chat_s_setDefault(VALUE klass, VALUE valObj)
{
    RAWTRACE("rb_Chat_s_set_default");

    const char* szID = rho_ruby_get_object_id(valObj);
    rho::CChatBase::setDefaultID(szID);

    return rho_ruby_get_NIL();
} 


static VALUE Chat_getSimpleStringProperty(int argc, VALUE *argv, const rho::String& id)
{
    ...
    chat.getSimpleStringProperty(argumentsAdapter(arguments), result); 
...
VALUE rb_Chat_getSimpleStringProperty(int argc, VALUE *argv, VALUE obj)
{
    ...
    return Chat_getSimpleStringProperty(argc, argv, id);
}
...
static VALUE Chat_setSimpleStringProperty(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    chat.setSimpleStringProperty(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Chat_setSimpleStringProperty(argc, argv, id);
}
...
static VALUE Chat_init(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    chat.init(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
static VALUE Chat_getProperty(int argc, VALUE *argv, const rho::String& id)
{
    ...
    chat.getProperty(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Chat_getProperty(argc, argv, id);
}
...
static VALUE Chat_getProperties(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    chat.getProperties(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Chat_getProperties(argc, argv, id);
}
...
static VALUE Chat_getAllProperties(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    chat.getAllProperties(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Chat_getAllProperties(argc, argv, id);
}
...
static VALUE Chat_setProperty(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    chat.setProperty(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Chat_setProperty(argc, argv, id);
}
...
static VALUE Chat_setProperties(int argc, VALUE *argv, const rho::String& id)
{
    RAWTRACE2("%s(id=%s)", __FUNCTION__, id.c_str());
    MethodResultJni result(true);
    if(!result)
    ...
    chat.setProperties(argumentsAdapter(arguments), result); 
    RAWTRACE("Native metod has invoked, converting result");
    VALUE res = CMethodResultConvertor().toRuby(result, false);
    RAWTRACE(__FUNCTION__);
    return res;
...
{
    rho::String id = rho_ruby_get_object_id(obj);
    return Chat_setProperties(argc, argv, id);
}
