...
public class Chat extends ChatBase implements IChat {
	...
	@Override
	public void init(String google_api_key, String google_app_id, String gcm_sender_id, String google_project_id, String google_storage_bucket, IMethodResult result) {
