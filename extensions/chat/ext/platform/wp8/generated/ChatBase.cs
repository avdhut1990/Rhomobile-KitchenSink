...
namespace ChatImpl
{
    abstract public class ChatBase : IChatImpl
    {
        ...
        abstract public void init(string google_api_key, string google_app_id, string gcm_sender_id, string google_project_id, string google_storage_bucket, IMethodResult oResult);
    }
